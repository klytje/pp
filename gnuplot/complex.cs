...
// print
public void print(){System.Console.WriteLine("{0} {1}",this.Re,this.Im);}
public void print(string s){System.Console.WriteLine(s+this);}
public void printf(string s){System.Console.WriteLine(s,this.Re,this.Im);}
// bool
